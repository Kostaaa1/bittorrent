...
func (tf *TorrentFile) Download(clientID [20]byte, port uint16) error {
	...
	// peer := Peer{IP: "185.203.56.65", Port: 55734 }
	// peer := Peer{IP: "82.65.106.14", Port: 6882}
	// peer := Peer{IP: "193.105.133.241", Port: 8999}
	// peer := Peer{IP: "143.177.152.79", Port: 2379}
	// peer := Peer{IP: "174.106.249.177", Port: 12881}
